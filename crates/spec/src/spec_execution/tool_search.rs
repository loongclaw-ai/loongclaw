...
use kernel::{
    ...
    PluginSetupReadinessContext, PluginSlotClaim, PluginTranslationReport,
...
use crate::spec_runtime::{
    ToolSearchEntry, ToolSearchResult, detect_provider_bridge_kind,
...
mod tests {
    ...
    fn execute_tool_search_derives_canonical_shim_from_compatibility_mode_metadata() {
        ...
        assert_eq!(results.len(), 1);
        assert_eq!(
            results[0].compatibility_mode.as_deref(),
