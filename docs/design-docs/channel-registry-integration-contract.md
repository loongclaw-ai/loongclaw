...
Slack, LINE, DingTalk, WhatsApp, generic Webhook, Google Chat, Signal,
...
This is the preferred path for channels such as Email, IRC, Nostr, Twitch,
Tlon, Zalo, Zalo Personal, or WebChat surfaces before real config or runtime
support lands. Channels such as generic Webhook, LINE, DingTalk, Google Chat,
Microsoft Teams, Mattermost, Nextcloud Talk, Synology Chat, and iMessage /
