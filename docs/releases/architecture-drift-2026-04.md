...
| daemon_lib | `structural_size` | `crates/daemon/src/lib.rs` | 6356 | 6500 | 144 | 210 | 210 | 0 | 100.0% | TIGHT | 6324 | 0.5% | PASS | 210 |
...
- TIGHT hotspots (>=95% of any tracked budget): spec_runtime (100.0%), spec_execution (96.4%), acpx_runtime (97.0%), channel_registry (99.7%), channel_config (100.0%), chat_runtime (95.6%), turn_coordinator (98.0%), tools_mod (98.4%), daemon_lib (100.0%), onboard_cli (97.1%)
...
<!-- arch-hotspot key=daemon_lib lines=6356 functions=210 -->
