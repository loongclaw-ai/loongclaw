...
## Summary
- Generated at: 2026-04-06T13:20:16Z
...
| acp_manager | `operational_density` | `crates/app/src/acp/manager.rs` | 3393 | 3600 | 207 | 8 | 12 | 4 | 94.2% | WATCH | 3383 | 0.3% | PASS | 8 |
| acpx_runtime | `operational_density` | `crates/app/src/acp/acpx.rs` | 2875 | 2800 | -75 | 56 | 65 | 9 | 102.7% | BREACH | 2698 | 6.6% | PASS | 56 |
...
| turn_coordinator | `structural_size,operational_density` | `crates/app/src/conversation/turn_coordinator.rs` | 11356 | 11200 | -156 | 108 | 120 | 12 | 101.4% | BREACH | 10831 | 4.8% | PASS | 98 |
| tools_mod | `structural_size` | `crates/app/src/tools/mod.rs` | 15054 | 15000 | -54 | 54 | 70 | 16 | 100.4% | BREACH | 14472 | 4.0% | PASS | 54 |
...
- BREACH hotspots (>100% of any tracked budget): acpx_runtime (102.7%), turn_coordinator (101.4%), tools_mod (100.4%)
- TIGHT hotspots (>=95% of any tracked budget): spec_runtime (100.0%), spec_execution (96.6%), channel_registry (97.4%), channel_config (100.0%), chat_runtime (95.6%), daemon_lib (99.4%), onboard_cli (99.2%)
...
<!-- arch-hotspot key=acp_manager lines=3393 functions=8 -->
<!-- arch-hotspot key=acpx_runtime lines=2875 functions=56 -->
...
<!-- arch-hotspot key=turn_coordinator lines=11356 functions=108 -->
<!-- arch-hotspot key=tools_mod lines=15054 functions=54 -->
