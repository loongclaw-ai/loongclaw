...
## Summary
- Generated at: 2026-03-29T23:40:49Z
...
| tools_mod | `structural_size` | `crates/app/src/tools/mod.rs` | 14182 | 15000 | 818 | 54 | 70 | 16 | 94.5% | WATCH |
| daemon_lib | `structural_size` | `crates/daemon/src/lib.rs` | 5068 | 6000 | 932 | 179 | 190 | 11 | 94.2% | WATCH |
...
- WATCH hotspots (>=85% and <95% of any tracked budget): spec_runtime (90.8%), memory_mod (87.5%), acp_manager (92.4%), tools_mod (94.5%), daemon_lib (94.2%)
...
<!-- arch-hotspot key=tools_mod lines=14182 functions=54 -->
<!-- arch-hotspot key=daemon_lib lines=5068 functions=179 -->
