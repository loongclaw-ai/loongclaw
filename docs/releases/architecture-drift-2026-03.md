...
## Summary
- Generated at: 2026-03-30T05:32:39Z
...
| daemon_lib | `structural_size` | `crates/daemon/src/lib.rs` | 5069 | 6000 | 931 | 179 | 190 | 11 | 94.2% | WATCH |
| onboard_cli | `structural_size` | `crates/daemon/src/onboard_cli.rs` | 2694 | 9800 | 7106 | 92 | 250 | 158 | 36.8% | HEALTHY |
...
- WATCH hotspots (>=85% and <95% of any tracked budget): spec_runtime (90.8%), memory_mod (87.5%), acp_manager (92.4%), tools_mod (94.8%), daemon_lib (94.2%)
...
<!-- arch-hotspot key=daemon_lib lines=5069 functions=179 -->
<!-- arch-hotspot key=onboard_cli lines=2694 functions=92 -->
