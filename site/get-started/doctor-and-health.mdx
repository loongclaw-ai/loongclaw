...
- Continue to [Managed Skills](/use-loongclaw/managed-skills) when the blocker is install policy, skill exposure, or browser preview enablement.
- Continue to [Browser And Web Boundaries](/use-loongclaw/browser-and-web-boundaries) when the blocker is a private host, domain allowlist, or browser runtime gate.
