...
| managed skill install, exposure, and persisted download policy | [Managed Skills](/use-loongclaw/managed-skills) |
| built-in web or browser private-host and domain rules | [Browser And Web Boundaries](/use-loongclaw/browser-and-web-boundaries) |
...
- [Managed Skills](/use-loongclaw/managed-skills) covers `[external_skills]`
  enablement, install policy, and browser preview bootstrap.
- [Browser And Web Boundaries](/use-loongclaw/browser-and-web-boundaries)
...
Continue to [Managed Skills](/use-loongclaw/managed-skills) when the blocker is
install or exposure policy. Continue to
[Browser And Web Boundaries](/use-loongclaw/browser-and-web-boundaries) when
...
| manage skill install and exposure policy | [Managed Skills](/use-loongclaw/managed-skills) |
| debug private-host, domain, or browser runtime gates | [Browser And Web Boundaries](/use-loongclaw/browser-and-web-boundaries) |
