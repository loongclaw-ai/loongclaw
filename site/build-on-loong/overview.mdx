...
| How do I actually write an extension on the current public branch? | [Extensions](/build-on-loong/extensions) | it documents the real scaffold, probe, and live shell-first routes |
...
2. Read [Extensions](/build-on-loong/extensions) if you want the concrete authoring and probe path for the current extension surfaces.
